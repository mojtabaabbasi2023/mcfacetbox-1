...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'um': RouteRecordInfo<'um', '/um', Record<never, never>, Record<never, never>>,
    'um-gate-management': RouteRecordInfo<'um-gate-management', '/um/gate-management', Record<never, never>, Record<never, never>>,
    'um-project-management': RouteRecordInfo<'um-project-management', '/um/project-management', Record<never, never>, Record<never, never>>,
    'um-user-role-management': RouteRecordInfo<'um-user-role-management', '/um/user-role-management', Record<never, never>, Record<never, never>>,
